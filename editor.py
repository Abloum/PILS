...
class Editor:
    ...
    def autoOn(self):
        ...
        for i in range(self.start, len(self.liste_actions)):
            ...
            if move[0] == "clear" or move[0] == "restore" or move[0] == "origin" or move[0] == "pendown" or move[
                0] == "penup":
        ...
        if (len(self.NomFichier.get()) > 0):
            ...
            if (self.check_mode_repete()):
                for i in range(len(self.liste_actions_repet)):
                    ...
                    if move[0] == "clear" or move[0] == "restore" or move[0] == "origin" or move[0] == "pendown" or \
                            move[0] == "penup":
                        ch += "<action move='" + move[0] + "'/>\n"
                    elif move[0] == "fpos":
                        ch += "<action move='fpos' value1='" + move[1] + "' value2='" + move[2] + "' />\n"
                    elif move[0] == "fcc":
                        ch += "<action move='fpos' value1='" + move[1] + "' value2='" + move[2] + "' value3='" + move[
                            3] + "'/>\n"
                    else:
                ...
                for i in range(len(self.liste_actions)):
                    ...
                    if move[0] == "clear" or move[0] == "restore" or move[0] == "origin" or move[0] == "pendown" or \
                        ...
                        moveTemp = move[1].replace("(", "").replace(")", "").split(",")
                        ch += "<action move='fcc' value1='" + moveTemp[0] + "' value2='" + moveTemp[1] + "' value3='" + \
                              moveTemp[2] + "'/>\n"
                    else:
                        ch += "<action move='" + move[0] + "' value='" + move[1] + "' />\n"
            ch += "</liste_actions>"
    ...
    def load(self):
        if (len(self.NomFichier.get()) > 0):
            ...
            for move in tree.xpath("/liste_actions/action"):
                if str(move.get("move")) == "clear" or str(move.get("move")) == "restore" or str(
                        move.get("move")) == "origin" or str(move.get("move")) == "pendown" or str(
                    move.get("move")) == "penup":
                    ...
                    self.add_list("fcc", "(" + str(move.get("value1")) + "," + str(move.get("value2")) + "," + str(
                        move.get("value3")) + ")")
                else:
