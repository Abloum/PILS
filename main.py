...
EnvoiForward = Button(zone2, text="avance", font=("Helvetica", 12), bg=couleur_boutons, fg=couleur_texte_boutons,
                      command=avance)
EnvoiBack = Button(zone2, text="recule", font=("Helvetica", 12), bg=couleur_boutons, fg=couleur_texte_boutons,
                   command=recule)
EnvoiLeft = Button(zone3, text="tourne a gauche", font=("Helvetica", 12), bg=couleur_boutons, fg=couleur_texte_boutons,
                   command=tour_gauche)
EnvoiRight = Button(zone3, text="tourne a droite", font=("Helvetica", 12), bg=couleur_boutons, fg=couleur_texte_boutons,
                    command=tour_droite)

liste = Listbox(Fenetre, bg=couleur_fond)
Suppr = Button(Fenetre, text="Supprimer ligne", font=("Helvetica", 12), bg=couleur_boutons, fg=couleur_texte_boutons,
               command=suppr_liste)
EnregistreXML = Button(Fenetre, text="Enregistre fichier", font=("Helvetica", 12), bg=couleur_boutons,
                       fg=couleur_texte_boutons)
ChargeXML = Button(Fenetre, text="Charger fichier", font=("Helvetica", 12), bg=couleur_boutons,
                   fg=couleur_texte_boutons)

Quitter = Button(Fenetre, text="Quitter", font=("Helvetica", 20), bg=couleur_boutons, fg=couleur_texte_boutons,
                 command=the_end)
...
liste.pack(fill=X)
text.pack(pady=(15, 5), padx=(90, 90), fill=X)
